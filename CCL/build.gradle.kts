...
val build = calculateBuildNumber(versionRoot);
...
fun calculateBuildNumber(version: String): Int {
    ...
    val lastBuildNumber = properties.getProperty(version, "0").toInt()
    val newBuildNumber = lastBuildNumber + 1

    properties.setProperty(version, newBuildNumber.toString())
