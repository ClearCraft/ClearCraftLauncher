...
public final class AboutPage extends StackPane {
    ...
    public AboutPage() {
        ComponentList about = new ComponentList();
        {
            ...
            launcher.setImage(FXUtils.newBuiltinImage("/assets/img/cc-icon.png"));
            launcher.setTitle("ClearCraft Launcher");
            launcher.setSubtitle(Metadata.VERSION);
            launcher.setExternalLink("https://www.clearcraft.cn");

            IconedTwoLineListItem author = new IconedTwoLineListItem();
            author.setImage(FXUtils.newBuiltinImage("https://qlogo1.store.qq.com/qzone/1614525528/1614525528/30"));
            author.setTitle("霁雾_ClearCraft");
            author.setSubtitle("bilibili @霁雾_ClearCraft");
            author.setExternalLink("https://space.bilibili.com/2066387998");
